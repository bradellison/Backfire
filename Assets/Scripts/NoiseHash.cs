...
public static class NoiseHash {
    ...
    public static float UnityPerlin1D(Vector3 point, float frequency) {
        return Mathf.PerlinNoise(point.x * frequency, 1);
    }

    public static float UnityPerlin2D(Vector3 point, float frequency) {
